...
public static class ToolbarStyles
{
    ...
    static ToolbarStyles( )
    {
        ...
        {
            fontSize = 20, alignment = TextAnchor.MiddleCenter, imagePosition = ImagePosition.ImageAbove, fontStyle = FontStyle.Bold, fixedWidth = 80,
        };
        CommandButtonStyle2 = new GUIStyle( "Command" )
        {
            fontSize = 22, alignment = TextAnchor.MiddleCenter, imagePosition = ImagePosition.ImageAbove, fontStyle = FontStyle.Bold, fixedWidth = 80,
        };
